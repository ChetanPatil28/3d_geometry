...
# Ans. P' = [R | -R*C] * P
pts3d_3 = np.matmul(Cam11.Rt, utils.euc_to_hom(pts3d_11).T) # [3, N]

# Q2. How to verify if the above formula is correct ?.
# Ans. Well, reverse-transform.
pts3d_11_est = np.matmul(np.hstack((Cam13.R.T, -Cam13.R.T.dot(Cam13.t))), utils.euc_to_hom(pts3d_3.T).T)

print(pts3d_11_est.T -  pts3d_11)
# print((utils.hom_to_euc(pts3d_3est) - pts3d_3).sum())

print("cam3 shape  ", pts3d_11_est.shape)


# print(np.hstack((Cam13.R.T, -Cam13.R.T.dot(Cam13.t))))